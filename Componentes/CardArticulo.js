...
import { Container, Header, Content, Card, CardItem, Thumbnail, 
    Text, Button, Left, Body, Right, Input, Form, Item, Label } from 'native-base';
            ...
            <Card style={styles.container} >
                ...
                <View style={styles.card} >
                    ...
                    <View style={styles.containerImagen} >
                        ...
                        <Card>
                            <CardItem>
                                <Image source={{uri:'https://satkit.com/image/cache/catalog/products/wasserdichte-aussenleuchte-led-30w-6500k-kaltweiss-led-lights-6040-700x700.jpg' }} 
                                style={styles.imagen} />
                            </CardItem> 
                        </Card>
                ...
                <View style={styles.contentCotizar} >
                    ...
                    <View style={styles.contentInput} >
                        <Form >
                            <Item regular stackedLabel style={{ flexDirection: 'row', padding: 10 }} >
                                <Icon active name='pencil' size={30} style={{ width: '25%', padding: 5, color: '#2E4053'}} />
                                <Input placeholder='Cantidad:' keyboardType="numeric" style={{ width: '75%', textAlign: 'center', borderWidth: 1 }} 
                    ...
                    <View style={styles.contentBtn} >
                        <Button rounded success style={{ width: '100%' }} >
                            <Input min={0} > </Input>
                            <Text style={{ textAlign: 'center', fontSize: 25, fontWeight: 'bold' }}> Cotizar </Text>
                        </Button>
                    </View>
