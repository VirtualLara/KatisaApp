          ...
          <Card style={{ flex: 0 }}>
            <CardItem>
              <Left>
                ...
                <Body>
                  <Text>Historia</Text>
                  <Text note>Desde: Diciembre 07, 2016</Text>
                </Body>
              </Left>
            </CardItem>
            ...
            <CardItem>
              <Body>
                ...
                <Text style={styles.parrafo}>
                  ...
                  tipo de artefactos para la iluminacionde sus hogares,
                  empresas, escuelasm obras o cualquier espacio que requiera de
                  iluminacion, ya que el giro al que se dedica la empresa es
                  venta de iluminacion en general.{" "}
                </Text>
              </Body>
            </CardItem>
          </Card>
          ...
          <Card style={{ flex: 0 }}>
            <CardItem>
              <Left>
                ...
                <Body>
                  <Text>Mision</Text>
                  <Text note>Donde queremos llegar.</Text>
                </Body>
              </Left>
            </CardItem>
          ...
          <Card style={{ flex: 0 }}>
            <CardItem>
              <Left>
                ...
                <Body>
                  <Text>Valores</Text>
                  <Text note>Lo que ofrecemos</Text>
                </Body>
              </Left>
            </CardItem>
