            ...
            noticia: [
                {
                    ...
                    infoNoticia:{
                        ...
                        parrafo2:'Por celebracion de los dias de semana santa, suspenderemos labores los dias 1 y 2 de abril del presente año.',
                        parrafo3:'Reanudando actividades el dia 3 de abril en todas nuestra sucursales.',
                ...
                },
                {
                    ...
                    infoNoticia:{
                        ...
                        parrafo2:'Tenemos el honor de informales que apartir de ahora tambien le estaremos atendiendo en nuestra nueva sucursal:',
                        parrafo3:'XALAPA CENTRO',
                        parrafo4:'Ubicada en la clalle: mi calle, de la colonia: mi colonia, de esta ciudad Xalapa, Veracruz. Con horario de atencion: 9:00 hrs - 20:00 hras.',
                        parrafo5:'POR APERTURA 50% DE DESCEUNTO EN TODA LA TIENDA...  "NO TE QUEDES SIN LUZ..." ',
                    }
                },
                {
                    ...
                    subtittle: 'FOCOS 10W',
                    infoNoticia:{
                        parrafo1:'Este mes apoyamos tu economia poniendo a tu disposicion esta promocion:',
                ...
                },
                {
                    ...
                    infoNoticia:{
                        parrafo1:'Por liquidacion de temporada, ponemos a tu disposocion auna amplia gama de articulos seleccionados en remate:',
                ...
                },
                {
                    ...
                    infoNoticia:{
                        parrafo1:'Un operador de comparación compara sus operandos y devuelve un valor lógico en función de si la comparación es verdadera (true) o falsa (false). Los operandos pueden ser valores numéricos, de cadena, lógicos u objetos. Las cadenas se comparan según el orden lexicográfico estándar, utilizando valores Unicode. En la mayoría de los casos, si los dos operandos no son del mismo tipo, JavaScript',
                        parrafo2:'intenta convertirlos a un tipo apropiado para la comparación. Este comportamiento generalmente resulta en comparar los operandos numéricamente. Las únicas excepciones a la conversión de tipos dentro de las comparaciones involucran a los operadores === y !==, que realizan comparaciones estrictas de igualdad y desigualdad.',
                        parrafo3:'Estos operadores no intentan convertir los operandos a tipos compatibles antes de verificar la igualdad. La siguiente tabla describe los operadores de comparación en términos de este código de ejemplo:',
                        parrafo4:'Para asignaciones más complejas, la sintaxis de asignación de desestructuración es una expresión de JavaScript que hace posible extraer datos de arreglos u objetos usando una sintaxis que refleja la construcción de arreglos y objetos literales.',
           ...
           <Container style = {styles.content} >
                ...
                <View style = {styles.contentBody}>
                        ...
                        <View  style={{ height: '30%' }}>
                            <CardItem style={{ height: '100%' }} >
                                <Left>
                                    ...
                                    <Text note> { this.state.noticia[ this.state.numNoticia ].tittle } </Text>
                                    </Body>
                                </Left>
                            </CardItem>
                        </View>
                    ...
                    <View style={{ height: '15%', flexDirection: "row", justifyContent: 'space-around',
                        ...
                        <Button iconLeft onPress={ () => { if( this.state.numNoticia !== 0 ){
                                                                this.setState({ numNoticia: this.state.numNoticia - 1 })
                                                            }else{ 
                                                                Alert.alert('Estas en la primer noticia.' + `\n` + 'No hay mas para mostar...')
                                                            } } } 
                        ...
                        <Button iconRight onPress={ ()=>{   
                                                            if( this.state.numNoticia <= 3 ){
                                                                ...
                                                                Alert.alert('Estas en la ultima noticia.' + `\n` + 'En breve publicaremos...')
                                                            } } } 
                                style={ styles.buttonArrow } >
